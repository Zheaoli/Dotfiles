...

;;;### (autoloads nil "info+" "info+.el" (23143 19112 887629 91000))
...
(custom-autoload 'Info-toc-outline-no-redundancy-flag "info+" t)
 ...
 (autoload 'Info-toc-outline "info+")
 (autoload 'Info-toc-outline-find-node "info+")
 (autoload 'Info-toc-outline-refontify-region "info+")
 (autoload 'Info-outline-promote "info+")
 (autoload 'Info-outline-demote "info+")
